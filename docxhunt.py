...
DOCXHUNT: A security-focused DOCX analysis tool that scans Microsoft Word (.docx) files for sensitive information.

"""
# Hide banner when output is redirected or piped
